...
Page({
  data: {
    ...
    videoList:
      [{
        ...
        "coverImage": "https://www.w3school.com.cn/i/shanghai_lupu_bridge.jpg",
  ...
  swipeUpper: function (e) {
    ...
    console.log("swipeUpper:" + newindex)
  ...
  swipeToEnd: function (e) {
    ...
    self.setData({
      videoList: self.controlVideoPlayer(res.concat(newdata), newindex + 1),
    });
